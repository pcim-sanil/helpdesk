 ...
 * sms_service_id: 468
 * contract code: 2925
 * email: mobileminded.momoxxio.psms.si@billingsupport-global.com
 */
class SlMomoxxioJob extends AutoProcessEmailJob
{
    ...
    {
        return 'https://oddesseysms.nl/si6';
    }
    ...
    {
        return [
            LanguageDectorService::SLOVENIAN_LANGUAGE,
    ...
    protected function getEmailTemplate(AutoProcessResponseTypeEnum $responseType, string $language = LanguageDectorService::ENGLISH_LANGUAGE): string
    {
        switch ($responseType) {
            ...
            case AutoProcessResponseTypeEnum::REFUND_REQUESTED:
                ...
                return 'mail.en.468.refund-request';
