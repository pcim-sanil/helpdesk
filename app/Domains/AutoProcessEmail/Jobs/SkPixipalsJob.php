 ...
 * sms_service_id: 466
 * contract code: 2923
 * email: tripletonic.pixipals.dcb.sk@billingsupport-global.com
 */
class SkPixipalsJob extends AutoProcessEmailJob
{
    ...
    {
        return 'https://oddesseysms.nl/sk2';
    }
    ...
    {
        return [
            LanguageDectorService::SLOVAK_LANGUAGE,
    ...
    protected function getEmailTemplate(AutoProcessResponseTypeEnum $responseType, string $language = LanguageDectorService::ENGLISH_LANGUAGE): string
    {
        switch ($responseType) {
            ...
            case AutoProcessResponseTypeEnum::REFUND_REQUESTED:
                ...
                return 'mail.en.466.refund-request';
