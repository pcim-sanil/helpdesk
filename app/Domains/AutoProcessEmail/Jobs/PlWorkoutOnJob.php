 ...
 * sms_service_id: 467
 * contract code: 2924
 * email: tripletonic.workouton.psms.pl@billingsupport-global.com
 */
class PlWorkoutOnJob extends AutoProcessEmailJob
{
    ...
    {
        return 'https://oddesseysms.nl/pl15';
    }
    ...
    protected function getEmailTemplate(AutoProcessResponseTypeEnum $responseType, string $language = LanguageDectorService::ENGLISH_LANGUAGE): string
    {
        switch ($responseType) {
            ...
            case AutoProcessResponseTypeEnum::REFUND_REQUESTED:
                ...
                return 'mail.en.467.refund-request';
