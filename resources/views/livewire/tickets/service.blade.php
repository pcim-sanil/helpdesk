...
" class="relative">
        ...
        <!-- Loading State -->
        <div wire:loading wire:target="loadServiceData" class="absolute inset-0 flex items-center justify-center bg-white/60 dark:bg-zinc-900/60 z-10">
    ...
    <div class="p-4 bg-white dark:bg-zinc-900 shadow-sm rounded-md">
        <!-- Content -->
            <div wire:loading.remove wire:target="loadServiceData" class="space-y-2">
                <div class="flex justify-between items-center mb-3">
                    <h2 class="text-lg font-semibold text-gray-800 dark:text-gray-200">Service Details</h2>
                    @if(empty($serviceData) && $ticketId)
