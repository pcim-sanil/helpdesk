                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 600px; background: #fff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.05); padding: 32px;">
                    <tr>
                        <td>
                            ...
                            <p style="color: #555; font-size: 16px;">
                                Workout ON is a one-time access fitness platform designed to support your health goals with expert-led workout videos, meal plans, motivating music, e-books, and fitness tracking tools. 
                                <br/>Whether you want to increase endurance, build strength, or enhance flexibility, our content is here to guide you. The service costs 30.75 PLN and does not renew automatically—no cancellation is required.
                            </p>
                            <p style="color: #555; font-size: 16px;">
