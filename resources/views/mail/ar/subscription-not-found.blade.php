...
<head>
    <meta charset="UTF-8">
    <title>لم يتم العثور على اشتراك نشط</title>
</head>
                    ...
                    <tr>
                        <td style="text-align: right;">
                            ...
                            <p style="color: #555; font-size: 16px;">
                                استناداً إلى سجلاتنا، يبدو أن الرقم <strong>{{ $MOBILE_NUMBER ?? 'المقدم' }}</strong> لم يتم الاشتراك فيه مطلقاً في خدمتنا. وبالتالي، لم يتم احتساب أي رسوم على هذا الرقم.
                            </p>
                            <p style="color: #555; font-size: 16px;">
                                إذا كنت بحاجة إلى أي معلومات إضافية أو تعتقد أن هناك خطأ، فيرجى الرد على هذا البريد الإلكتروني وسنكون سعداء بمساعدتك.
                            </p>
