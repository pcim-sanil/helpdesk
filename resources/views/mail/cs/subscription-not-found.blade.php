                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 600px; background: #fff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.05); padding: 32px;">
                    <tr>
                        <td>
                            ...
                            <p style="color: #555; font-size: 16px;">
                                Rádi bychom vás informovali, že vaše žádost je v současné době posuzována. Náš tým zjišťuje podrobnosti a my se vám co nejdříve ozveme s dalšími informacemi.
                            </p>
                            <p style="color: #555; font-size: 16px;">
                                Vážíme si vaší trpělivosti a zajistíme, že brzy obdržíte odpověď.
                            </p>
