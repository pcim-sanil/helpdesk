...
<head>
    <meta charset="UTF-8">
    <title>Pretplata nije pronađena</title>
</head>
        ...
        <tr>
            <td align="center">
                <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 600px; background: #fff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.05); padding: 32px;">
                    <tr>
                        <td>
                            <h2 style="color: #333; margin-top: 0;">Pretplata nije pronađena</h2>
                            ...
                            <p style="color: #555; font-size: 16px;">
                                Želimo da vas obavestimo da je vaš zahtev trenutno u fazi razmatranja. Naš tim ispituje detalje, a mi ćemo vam se javiti sa dodatnim informacijama u najkraćem mogućem roku.
                            </p>
                            <p style="color: #555; font-size: 16px;">
                                Cenimo vaše strpljenje i postaraćemo se da uskoro dobijete odgovor.
                            </p>
