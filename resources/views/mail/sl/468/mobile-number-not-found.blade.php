                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 600px; background: #fff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.05); padding: 32px;">
                    <tr>
                        <td>
                            ...
                            <p style="color: #555; font-size: 16px;">
                                Da bi lahko nadaljevali postopek odjave od naše storitve, vas prosimo, da nam posredujete zadevno telefonsko številko, vključno z ustrezno klicno številko države.
                            </p>
                            <p style="color: #555; font-size: 16px;">
                                Cenimo vaše sodelovanje v tej zadevi in ​​vam zagotavljamo, da bomo vašo zahtevo obravnavali hitro in učinkovito.
                            </p>
                            <p style="color: #555; font-size: 16px;">
                                Zahvaljujemo se vam za vašo nadaljnjo podporo.
                            </p>
